...
GUI = Tk()
GUI.title('โปรแกรมบันทึกค่าใช้จ่าย by Dear')
...
# Help
def About():
	messagebox.showinfo('About','สวัสดีค่ะ โปรแกรมนี้คือโปรแกรมบันทึกข้อมูลค่าใช้จ่าย\nสนใจบริจาคเราไหม? ขอ 1 BTC ก็พอแล้ว')
...
# Donate
def Donate():
	messagebox.showinfo('Donate','Contact e-mail: s.danattha@gmail.com')
...
icon_t1 = PhotoImage(file='Add.png').subsample(20) #  .subsample(2) = ย่อรูป
icon_t2 = PhotoImage(file='list.png').subsample(20)
...
main_icon = PhotoImage(file='BG.png').subsample(5)
...
#resulttable.insert('','0',value=['จันทร์','น้ำดิ่ม',30,5,150])
#resulttable.insert('','end',value=['อังคาร','น้ำดิ่ม',30,5,150])		
